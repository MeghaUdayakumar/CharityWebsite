...
namespace WebsiteAPI.Controllers
{
    ...
    public class OutletController : ControllerBase
    {
        ...
        [HttpPost]
        public ActionResult <IEnumerable<OutletController>> CreateOutlet()
        {
            var OutletItems = _repository.GetAllOutlets();
        ...
        [HttpPost]
        public ActionResult <IEnumerable<OutletController>> CreateAllOutlet()
        {
            var OutletItems = _repository.GetAllOutlets();
        ...
        [HttpPut]
        public ActionResult <IEnumerable<OutletController>> UpdateOutlet()
        {
            var OutletItems = _repository.GetAllOutlets();
